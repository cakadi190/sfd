...
<div id="footer-mobile">
  <div class="d-flex flex-column justify-content-around bg-cl-secondary">
    <div class="d-flex flex-column justify-content-around bg-cl-secondary p-5">
      ...
      <p
        class="width-container-small cl-secondary font-type-tertiary font-size-septenary align-self-center text-center">
      ...
      <p class="width-container-small cl-secondary font-type-tertiary font-size-septenary align-self-center">Endokemi
      ...
      <p class="cl-secondary font-type-tertiary font-size-septenary align-self-center text-center">71, Ayer Rajah
