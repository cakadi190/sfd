  ...
  <main>
    <div class="jumbotron jumbotron-fluid height-med-jumbotron bg-hero" id="hero">
      <div class="container container-fluid d-flex flex-column">
        ...
        <p class="text-center cl-secondary font-type-secondary font-size-septenary align-self-center font-line-height mt-3">Whether it's
        ...
        <a href="/register" class="btn btn-hero align-self-center cl-secondary mt-5 bg-cl-tertiary font-size-septenary">Get Loans</a>
      </div>
    </div>
    ...
    <div class="container d-flex flex-column justify-content-around bg-cl-primary" id="section3-mobile">
      ...
      <a href="/register" class="btn btn-hero align-self-center cl-secondary mt-5 mb-5 bg-cl-tertiary font-size-septenary">Get Loans</a>
    </div>
    <!--Desktop Section 3-->
    <div class="bg-cl-primary d-flex flex-column justify-content-around" id="section3-desktop">
      ...
      <div class="container d-flex flex-row justify-content-around mt-5" id="section3-main">
        <div class="container d-flex flex-column justify-content-around">
          ...
          <img src="{{asset('assets/Search_engine _Isometric.svg')}}" alt="image"
            class="image-fluid custom-img align-self-center">
          <h3 class="align-self-center font-type-secondary font-size-tertiary cl-senary">Submit Application</h3>
          <h4
            class="align-self-center font-type-tertiary font-line-height-big cl-septenary font-size-quaternary width-container-small text-center">
            Apply for our financing solution and submit the necessary details.</h4>
        </div>
        ...
        <div class="container d-flex flex-column">
          ...
          <h4
            class="align-self-center font-type-tertiary cl-septenary font-line-height-big font-size-quaternary width-container-small text-center">
            If funding is successful, the funds will be disbursed to you within two days.</h4>
        </div>
      </div>
      <div class="d-flex flex-column justify-content-around">
    ...
    <div class="container d-flex flex-column justify-content-around mt-5" id="section4-mobile">
      ...
      <a href="/register" class="btn btn-call-to-action font-size-septenary cl-secondary bg-cl-tertiary align-self-center">Apply Now</a>
    </div>
    <!--Desktop Section 4-->
    ...
    <div id="section5-desktop">
      <div class="d-flex flex-column justify-content-around pos-relative pb-5">
        ...
        <div class="d-flex flex-row justify-content-beetwen ml-5">
          ...
          <div class="d-flex flex-column justify-content-center mt-5 ml-2">
            <h4 class="font-type-secondary font-size-tertiary cl-quinary">Full Transparency</h4>
            <p class="width-container-small font-type-tertiary font-size-septenary font-line-height-med">We will disclose the costs and fees
          ...
          <div class="d-flex flex-column justify-content-center mt-5 ml-2">
            ...
            <p class="width-container-small font-type-tertiary font-size-septenary">Enjoy low-interest rates and
        ...
        <div class="d-flex flex-row justify-content-beetwen ml-5">
          ...
          <div class="d-flex flex-column justify-content-center mt-5 ml-2">
            ...
            <p class="width-container-small font-type-tertiary font-size-septenary">Our online application saves you the hassle of leaving the comfort of home or work.</p>
          </div>
          <img src="{{asset('assets/review_4.svg')}}" alt="image" class="image-fluid img-mini">
          <div class="d-flex flex-column justify-content-center mt-4 ml-2">
            <div class="d-flex flex-column justify-content-start">
            ...
            <p class="width-container-small font-type-tertiary font-size-septenary">We focus on your business potential and want to help you grow.</p>
          </div>
        </div>
