  ...
  <main>
    <div class="jumbotron jumbotron-fluid height-med-jumbotron bg-hero" id="hero">
      <div class="container container-fluid d-flex flex-column">
        <h2 class="font-type-secondary cl-secondary text-center font-size-header mt-4">Get Fast & Easy Loan.</h2>
        <p class="text-center cl-secondary font-type-tertiary font-size-subtitle width-container-smallmed align-self-center font-line-height mt-4">Whether it's
      ...
      <div class="d-flex flex-column justify-content-around pt-2">
        ...
        <div class="d-flex flex-row justify-content-center">
          ...
          <div class="d-flex flex-column justify-content-around">
            <h3 class="cl-tertiary font-size-tertiary">Funding</h3>
    ...
    <div id="box-card-desktop">
      <div class="d-flex flex-row justify-content-around pt-4">
        <div class="d-flex flex-row font-type-primary">
          <h3 class="cl-tertiary font-size-tertiary font-type-tertiary">About</h3>
          <h3 class="ml-2 cl-quaternary border-bottom-full font-size-tertiary font-type-tertiary">SmartFunding</h3>
      ...
      <div class="container mt-3 width-text-card align-self-center pb-2">
        <p class="text-center font-size-septenary font-type-tertiary pl-7 pr-7">The on-going pandemic has made it challenging for
          everyone, not just businesses. Launched in 2021, we envision to alleviate the financial burden for people
          affected through our fast, reliable, and flexible microloans solutions.</p>
      </div>
    </div>
    ...
    <div class="container d-flex flex-column justify-content-around bg-cl-primary" id="section3-mobile">
      <h3 class="cl-quinary font-type-primary font-size-tertiary width-small-container text-center align-self-center">
      ...
      <div class="d-flex flex-column justify-content-around mt-5">
        ...
        <h3 class="align-self-center font-type-secondary cl-senary font-size-quaternary">Submit Application</h3>
        <h4
          class="align-self-center font-type-tertiary font-size-septenary cl-septenary font-size-small width-medium-container text-center">
      ...
      <div class="d-flex flex-column justify-content-around mt-5">
        ...
        <img src="{{asset('assets/Checklist_Isometric.svg')}}" alt="image"
          class="image-fluid custom-img align-self-center">
        <h3 class="align-self-center font-type-secondary cl-senary font-size-quaternary">Review Application</h3>
        <h4
          class="align-self-center font-type-tertiary font-size-septenary cl-septenary font-size-small width-medium-container text-center">
      ...
      <div class="d-flex flex-column justify-content-around mt-5">
        ...
        <img src="{{asset('assets/Money_transfer _Isometric.svg')}}" alt="image"
          class="image-fluid custom-img align-self-center">
        <h3 class="align-self-center font-type-secondary cl-senary font-size-quaternary">Receive Money</h3>
        <h4
          class="align-self-center font-type-tertiary font-size-septenary cl-septenary font-size-small width-medium-container text-center">
          If funding is successful, the funds will be disbursed to you within two days.</h4>
      </div>
      <a href="/register" class="btn btn-hero font-type-secondary align-self-center cl-secondary mt-5 mb-5 bg-cl-tertiary font-size-septenary">Get Loans</a>
    </div>
    ...
    <div class="bg-cl-primary d-flex flex-column justify-content-around" id="section3-desktop">
      ...
      <div class="d-flex flex-column justify-content-start align-self-center">
        <h3
          class="cl-quinary font-type-primary font-line-height-super-big font-size-secondary width-header-small text-center align-self-center"
      ...
      <div class="container d-flex flex-row justify-content-around mt-5" id="section3-main">
        <div class="container d-flex flex-column">
          ...
          <h4
            class=" pl-2 pr2 align-self-center font-type-tertiary font-line-height-med cl-septenary font-size-septenary width-container-small text-center">
            Apply for our financing solution and submit the necessary details.</h4>
        </div>
        <div class="container d-flex flex-column">
          <img src="{{asset('assets/number_count_2.png')}}" alt="1"
          ...
          <h4
            class="pl-2 pr-2 align-self-center font-type-tertiary font-line-height-med cl-septenary font-size-septenary width-container-small text-center">
            Upon submission, your application will be reviewed by our credit and risk team.</h4>
        </div>
        <div class="container d-flex flex-column">
          <img src="{{asset('assets/number_count_3.png')}}" alt="1"
          ...
          <h4
            class=" pl-2 pr-2 align-self-center font-type-tertiary cl-septenary font-line-height-med font-size-septenary width-container-small text-center">
            If funding is successful, the funds will be disbursed to you within two days.</h4>
        </div>
      </div>
      <div class="d-flex flex-column justify-content-around">
        <a href="/register"
          class="btn btn-hero mb-5 align-self-center font-type-secondary cl-secondary mt-5 bg-cl-tertiary">Get Loans</a>
    ...
    <div class="container d-flex flex-column justify-content-around mt-5" id="section4-mobile">
      ...
      <a href="/register" class="btn btn-hero font-size-septenary font-type-secondary cl-secondary bg-cl-tertiary align-self-center">Apply Now</a>
    </div>
    <!--Desktop Section 4-->
    ...
    <div id="section5-mobile">
      ...
      <div class="d-flex flex-column justify-content-around mt-5 mb-5">
        ...
        <p
          class="mr-4 ml-4 width-container-small font-type-tertiary font-size-septenary font-line-height-med align-self-center text-center">
        ...
        <a href="/register"
          class="btn btn-hero bg-cl-tertiary font-type-secondary cl-secondary ml-2 mt-3 align-self-center">Apply Now</a>
      </div>
    </div>
      ...
      <div class="d-flex flex-column justify-content-evenly pos-relative pb-5" id="section5-bigscreen">
        ...
        <div class="d-flex flex-row justify-content-beetwen ml-5">
          ...
          <div class="d-flex flex-column justify-content-center ml-2 pt-4">
            ...
            <p class="width-container-super-small font-type-tertiary font-size-septenary font-line-height-med">We will disclose the costs and fees
          ...
          <div class="d-flex flex-column justify-content-center ml-2 mt-5 pt-3">
            ...
            <p class="width-container-super-small font-type-tertiary font-size-septenary">Enjoy low-interest rates and
        ...
        <div class="d-flex flex-row justify-content-beetwen ml-5">
          ...
          <div class="d-flex flex-column justify-content-center ml-2 pt-6">
            ...
            <p class="width-container-super-small font-type-tertiary font-size-septenary">Our online application saves you the hassle of leaving the comfort of home or work.</p>
          </div>
          ...
          <div class="d-flex flex-column justify-content-center ml-2 pt-5">
            ...
            <p class="width-container-super-small font-type-tertiary font-size-septenary">We focus on your business potential and want to help you grow.</p>
          </div>
        </div>
        ...
        <div class="d-flex flex-row justify-content-around mt-5">
          <div class="d-flex flex-column justify-content-start">
            ...
            <h4 class="font-type-secondary font-size-tertiary cl-quinary align-self-center text-center">Full
              Transparency</h4>
            <p class="width-container-small-tablet font-type-tertiary font-size-quaternary align-self-center text-center">We
          ...
          <div class="d-flex flex-column justify-content-start">
            ...
            <h4 class="font-type-secondary font-size-tertiary cl-quinary align-self-center text-center">Easy and
              Seamless</h4>
            <h4 class="font-type-secondary font-size-tertiary cl-quinary align-self-center text-center">Application</h4>
            <p class="width-container-small-tablet font-type-tertiary font-size-quaternary align-self-center text-center">Our online application saves you the hassle of leaving the comfort of home or work.</p>
          </div>
        </div>
        <div class="d-flex flex-row justify-content-around mt-5">
          <div class="d-flex flex-column justify-content-start">
            ...
            <h4 class="font-type-secondary font-size-tertiary cl-quinary align-self-center text-center">Flexible
              Repayment</h4>
            <p class="width-container-small-tablet font-type-tertiary font-size-quaternary align-self-center text-center">Enjoy
          ...
          <div class="d-flex flex-column justify-content-start">
            ...
            <h4 class="font-type-secondary font-size-tertiary cl-quinary align-self-center text-center">Financing</h4>
            <p class="width-container-small-tablet font-type-tertiary font-size-quaternary align-self-center text-center">We focus on your business potential and want to help you grow.</p>
          </div>
        </div>
        <a href="/register"
