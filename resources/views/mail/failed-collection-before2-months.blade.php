...
<body>
    ...
    <br/>
    <p>Total Due: RM {{ $mailData['totalOutstandingAmount'] }}</p>
    <br/>
    <p>Due Date: {{ $mailData['dueDate'] }}</p>
    <br/>
    <p>Please be advised that your loan installment is overdue. Please arrange payment to avoid any late charges.</p>
    <br/>
