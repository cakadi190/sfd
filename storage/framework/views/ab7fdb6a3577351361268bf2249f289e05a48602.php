...
<head>
  ...
  <script src="<?php echo e(asset('js/style.js')); ?>" type="application/javascript" defer></script>
  <title>SMARTFUNDING Direct</title>
</head>

<body>
  <?php echo $__env->make('layouts.landing_page.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  ...
  <main>
    ...
    <div id="menu-bar">
      <ul id="container-menu">
        <li class="align-self-end mt-4">
          <img src="<?php echo e(asset('assets/close_nav_mobile.svg')); ?>" alt="close" class="image-fluid" id="close-mobile">
        </li>
    ...
    <div class="d-flex flex-column justify-content-around bg-cl-primary" id="section3-mobile">
      ...
      <div class="d-flex flex-column justify-content-around mt-5">
        <img src="<?php echo e(asset('assets/number_count_1.png')); ?>" alt="1"
          class="image-fluid number-count-img-mobile align-self-center">
        <img src="<?php echo e(asset('assets/Search_engine _Isometric.svg')); ?>" alt="image"
      ...
      <div class="d-flex flex-column justify-content-around mt-5">
        <img src="<?php echo e(asset('assets/number_count_2.png')); ?>" alt="1"
          class="image-fluid number-count-img-mobile align-self-center">
        <img src="<?php echo e(asset('assets/Checklist_Isometric.svg')); ?>" alt="image"
          class="image-fluid custom-img align-self-center">
      ...
      <img src="<?php echo e(asset('assets/Polygon_6.svg')); ?>" alt="Polygon" class="image-fluid image-float">
      <div class="d-flex flex-column justify-content-around mt-5">
        <img src="<?php echo e(asset('assets/number_count_3.png')); ?>" alt="1"
          class="image-fluid number-count-img-mobile align-self-center">
        <img src="<?php echo e(asset('assets/Money_transfer _Isometric.svg')); ?>" alt="image"
          class="image-fluid custom-img align-self-center">
    ...
    <div class="bg-cl-primary d-flex flex-column justify-content-around" id="section3-desktop">
      ...
      <div class="container d-flex flex-row justify-content-around mt-5" id="section3-main">
        <div class="container d-flex flex-column .pos-relative">
          <img src="<?php echo e(asset('assets/Polygon_6.svg')); ?>" alt="LOGO" class="img-fluid float-img-desktop-left-1">
          <img src="<?php echo e(asset('assets/number_count_1.png')); ?>" alt="1"
      ...
      <div class="d-flex flex-column justify-content-around">
        ...
        <img src="<?php echo e(asset('assets/Polygon_5.svg')); ?>" alt="LOGO" class="img-fluid float-img-desktop-right-1">
      </div>
    </div>
    ...
    <div class="container d-flex flex-column justify-content-around mt-5" id="section4-mobile">
      ...
      <div class="align-self-center">
        <div class="d-flex flex-row justify-content-start">
          <img src="<?php echo e(asset('assets/Polygon_small.svg')); ?>" alt="bullet icon"
    ...
    <div id="section4-desktop">
      <div class="d-flex flex-row justify-content-center mt-70px">
        <img src="<?php echo e(asset('assets/Group_3301.svg')); ?>" alt="Image" class="image-fluid img-med">
        <div class="ml-5">
      ...
      <div class="d-flex flex-column justify-content-around mt-90px ml-5">
        ...
        <div class="d-flex flex-row justify-content-around mt-5 pl-25px">
          <div class="d-flex flex-column justify-content-start pr-5">
            ...
            <img src="<?php echo e(asset('../assets/Group_3301.svg')); ?>" alt="image" class="image-fluid img-unique">
        </div>
      </div>
    </div>
    ...
    <div id="section5-mobile">
      ...
      <div class="d-flex flex-column justify-content-around mt-5 mb-5">
        <img src="<?php echo e(asset('assets/review_1.svg')); ?>" alt="image" class="image-fluid img-mini-mobile align-self-center">
        ...
        <img src="<?php echo e(asset('assets/review_3.svg')); ?>" alt="image"
        ...
        <img src="<?php echo e(asset('assets/review_2.svg')); ?>" alt="image"
          class="image-fluid img-mini-mobile align-self-center mt-5">
        ...
        <img src="<?php echo e(asset('assets/review_4.svg')); ?>" alt="image"
          class="image-fluid img-mini-mobile align-self-center mt-5">
    ...
    <div id="section5-desktop">
      <div class="d-flex flex-column justify-content-evenly pos-relative pb-5" id="section5-bigscreen">
        <img src="<?php echo e(asset('assets/Polygon_6.svg')); ?>" alt="LOGO" class="img-fluid float-img-desktop-left-2"
          id="img-hide">
        ...
        <div class="d-flex flex-row justify-content-beetwen mt-5 ml-5">
          <img src="<?php echo e(asset('assets/review_1.svg')); ?>" alt="image" class="image-fluid img-mini">
          ...
          <img src="<?php echo e(asset('assets/review_2.svg')); ?>" alt="image" class="image-fluid img-mini ml-5">
        ...
        <div class="d-flex flex-row justify-content-beetwen mt-5 ml-5">
          <img src="<?php echo e(asset('assets/review_3.svg')); ?>" alt="image" class="image-fluid img-mini">
          ...
          <img src="<?php echo e(asset('assets/review_4.svg')); ?>" alt="image" class="image-fluid img-mini ml-5">
        ...
        <img src="<?php echo e(asset('assets/Group.svg')); ?>" alt="LOGO" class="img-fluid float-img-desktop-right-2" id="img-hide">
      </div>
    </div>
    ...
    <div id="section5-tablet">
      <div class="d-flex flex-column justify-content-around mt-90px mb-5" id="tablet-bg">
        ...
        <div class="d-flex flex-row justify-content-around mt-5">
          <div class="d-flex flex-column justify-content-start">
            <img src="<?php echo e(asset('assets/review_1.svg')); ?>" alt="image" class="image-fluid img-mini align-self-center">
          ...
          <div class="d-flex flex-column justify-content-start">
            <img src="<?php echo e(asset('assets/review_3.svg')); ?>" alt="image" class="image-fluid img-mini align-self-center">
        ...
        <div class="d-flex flex-row justify-content-around mt-5">
          <div class="d-flex flex-column justify-content-start">
            <img src="<?php echo e(asset('assets/review_2.svg')); ?>" alt="image" class="image-fluid img-mini align-self-center">
          ...
          <div class="d-flex flex-column justify-content-start">
            <img src="<?php echo e(asset('assets/review_4.svg')); ?>" alt="image" class="image-fluid img-mini align-self-center">
...
<?php /**PATH C:\laragon\www\smartfunding\resources\views/index.blade.php ENDPATH**/ ?>