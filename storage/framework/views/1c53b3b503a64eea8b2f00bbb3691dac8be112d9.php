...
<div id="footer-desktop">
  <div class="d-flex flex-row justify-content-around pt-5 bg-cl-secondary p-5">
    <div class="d-flex flex-column justify-content-center">
      <img src="<?php echo e(asset('images/logo/sfd-wh.svg')); ?>" alt="Logo" class="image-fluid img-small-footer">
      <h4 class="font-type-tertiary font-footer-primary mt-3 cl-quaternary">License</h4>
      <p class="width-container-small cl-secondary font-footer-secondary font-size-septenary">Smartfunding Pte. Ltd.
    ...
    <div class="d-flex flex-column justify-content-around">
      <div class="d-flex flex-column justify-content-start ml-3">
        <h4 class="font-type-tertiary font-footer-primary cl-quaternary">Get in Touch</h4>
        <p class="width-container-small cl-secondary font-type-tertiary font-footer-secondary">Endokemi kaning. Bepir
          detregt. Vabel sovöpör. Milingar. Bigt seryrat. </p>
      </div>
      <div class="d-flex flex-column justify-content-start ml-3">
        <h4 class="font-type-tertiary font-footer-primary cl-quaternary">Address</h4>
        <p class="width-container-small cl-secondary font-type-tertiary font-footer-secondary">71, Ayer Rajah Crescent,
    ...
    <div class="d-flex flex-column justify-content-around ">
      ...
      <div class="d-flex flex-row justify-content-around">
        <img src="<?php echo e(asset('assets/Facebook.svg')); ?>" alt="Facebook" class="image-fluid img-icon-mini">
        <img src="<?php echo e(asset('assets/Twitter.svg')); ?>" alt="Twitter" class="image-fluid img-icon-mini">
        <img src="<?php echo e(asset('assets/Linkedin.svg')); ?>" alt="Linkedin" class="image-fluid img-icon-mini">
        <img src="<?php echo e(asset('assets/Instagram.svg')); ?>" alt="instagram" class="image-fluid img-icon-mini">
      </div>
    </div>
  </div>
...
<div id="footer-mobile">
  <div class="d-flex flex-column justify-content-around bg-cl-secondary">
    <div class="d-flex flex-column justify-content-around bg-cl-secondary p-5">
      <img src="<?php echo e(asset('images/logo/sfd-wh.svg')); ?>" alt="Logo" class="image-fluid img-small-footer-px align-self-center">
      <h4 class="font-type-tertiary font-footer-primary mt-5 cl-quaternary align-self-center">License</h4>
      <p
        class="width-container-mini-inter1-px cl-secondary font-type-tertiary font-footer-secondary align-self-center text-center">
      ...
      <h4 class="font-type-tertiary font-footer-primary cl-quaternary align-self-center mt-3">Get in Touch</h4>
      <p class="width-container-inter1-px cl-secondary font-type-tertiary font-footer-secondary align-self-center text-center">Endokemi
        kaning. Bepir detregt. Vabel sovöpör. Milingar. Bigt seryrat. </p>
      <h4 class="font-type-tertiary font-footer-primary cl-quaternary align-self-center mt-3">Address</h4>
      <p class="cl-secondary font-type-tertiary font-footer-secondary align-self-center text-center">71, Ayer Rajah
        Crescent, <br class="text-center" />#06-06, Singapore <br class="text-center" />139951.</p>
      ...
      <div class="d-flex flex-row justify-content-center mt-4">
        <img src="<?php echo e(asset('assets/Facebook.svg')); ?>" alt="Facebook" class="image-fluid img-icon-mini">
        <img src="<?php echo e(asset('assets/Twitter.svg')); ?>" alt="Twitter" class="image-fluid img-icon-mini ml-3">
        <img src="<?php echo e(asset('assets/Linkedin.svg')); ?>" alt="Linkedin" class="image-fluid img-icon-mini ml-3">
        <img src="<?php echo e(asset('assets/Instagram.svg')); ?>" alt="instagram" class="image-fluid img-icon-mini ml-3">
      </div>
    </div>
    <div class="d-flex flex-column justify-content-around mt-5 bg-cl-footer p-3">
      <div class="d-flex flex-row justify-content-around align-self-center mb-3">
        <h5 class="font-type-tertiary font-footer-secondary cl-octonary align-self-center">Privacy policy</h5>
        <h5 class="ml-5 font-type-tertiary font-footer-secondary cl-octonary align-self-center">Terms of use</h5>
      </div>
      <h5 class="font-type-tertiary font-footer-secondary cl-secondary align-self-center">© 2020 All rights reserved.</h5>
      <h5 class="font-type-tertiary font-footer-secondary cl-quaternary align-self-center">Smartfunding Pte. Ltd</h5>
    </div>
  </div>
</div>
...
<div id="footer-tablet">
  <div class="d-flex flex-column justify-content-between bg-cl-secondary p-5">
    <img src="<?php echo e(asset('images/logo/sfd-wh.svg')); ?>" alt="Logo" class="image-fluid img-small-footer-px align-self-start">
    ...
    <div class="d-flex flex-row justify-content-between align-self-start mt-5">
      <div class="d-flex flex-column justify-content-around">
        ...
        <p class="width-container-mini-inter1-px cl-secondary font-type-tertiary font-footer-secondary align-self-start">
          Smartfunding Pte. Ltd. Regulated by Monetary Authority of Singapore (MAS). License no: CMS-100637-1 Capital
          Market Services (Dealing in Securities)</p>
...
<?php /**PATH C:\laragon\www\smartfunding\resources\views/layouts/landing_page/footer.blade.php ENDPATH**/ ?>