  ...
  <div class="mx-md-5 mx-0" style="position: relative">
    ...
    <div class="card p-0 p-md-5 m-md-5 m-0 mb-0">
      <div class="card-body">
        ...
        <div class="text-center text-info my-3" style="font-weight: 600"><?php echo e($data->loan_id); ?></div>
          ...
          <div class="col-lg-5">
            ...
            <div class="card card-body bg-primary">
              ...
              <div class="text-center text-white">
                ...
                <p class="font-weight-bold"><?php echo e(Carbon\Carbon::parse($data->period)->format('M Y')); ?></p>

                <h3 class="mt-5 mb-2"><?php echo e(number_format($data->finance_amount, 2, '.', ',')); ?></h3>
    ...
    <img src="<?php echo e(asset('images/pay-man.png')); ?>" alt="Man" class="d-none d-md-block d-sm-none" style="position: absolute;bottom: -6.5rem;right: -10rem;height: 23rem;" />
...
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smartfunding\resources\views/paynow-check.blade.php ENDPATH**/ ?>