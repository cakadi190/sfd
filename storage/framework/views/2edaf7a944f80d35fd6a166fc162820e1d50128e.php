    ...
    <div class="card p-0 p-md-4 m-md-5 m-0 mb-0">
      <div class="card-body">
        ...
        <div class="row justify-content-center align-items-center">
          <div class="col-lg-8">
            <form action="<?php echo e(route('pay.checking')); ?>" method="post">
              <?php echo csrf_field(); ?>
              ...
              <div class="form-group py-3 py-lg-5 m-0 m-md-4 text-center text-lg-left">
                ...
                <div class="row mt-1">
                  <div class="col-lg-8 mb-4 mb-md-0">
                    <input type="text" class="form-control" id="number" name="number" placeholder="Enter your loan identification number" <?php echo e(old('number') ? "value=\"" . old('number') . "\"" : ''); ?> />
                  </div>
...
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smartfunding\resources\views/paynow-index.blade.php ENDPATH**/ ?>