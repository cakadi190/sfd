<header id="responsive-header-desktop">
  <nav class="navbar navbar-light bg-cl-primary navbar-expand-md" id="responsive-nav">
    <a class="navbar-brand" href="/">
      <img class="img-fluid ml-5 logo-size mt-1 mb-1" id="logo" src="<?php echo e(asset('images/logo/sfd-bl.svg')); ?>" height="50px" alt="logo-brand" />
    </a>
...
<header id="responsive-header-mobile">
  <nav class="d-flex flex-row justify-content-between container-header p-2">
    <img class="img-fluid ml-5 logo-size mt-1 mb-1" id="logo" src="<?php echo e(asset('assets/mobile-logo.svg')); ?>" height="50px" alt="logo-brand" />
    <img src="<?php echo e(asset('assets/icon_menu_mobile.svg')); ?>" alt="Menu" class="img-fluid ham-mobile mr-5 mt-1 mb-1" id="toggler-menu">
  </nav>
</header>
<?php /**PATH C:\laragon\www\smartfunding\resources\views/layouts/landing_page/header.blade.php ENDPATH**/ ?>